...
for (Int_t run=0;run<1;run++) {
    ...
    TH1F *hrdtTOTE2[4];
    for (Int_t i=0;i<4;i++) {
        hrdtTOTE[i] = new TH1F(Form("hrdtTOTE%d",i),Form("hrdtTOTE%d_%d",i,runList[run]),1000,3650,4800);
        hrdtTOTE2[i] = new TH1F(Form("hrdtTOTE2%d",i),Form("hrdtTOTE2%d_%d",i,runList[run]),1000,3650,4800);
