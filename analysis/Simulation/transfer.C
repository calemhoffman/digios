...
// when running no detectorGeo setting, default B-field is 2.5 T

void transfer(string basicConfig = "basicReactionConfig.txt", 
   ...
   for( int i = 0; i < numEvent; i++){
      ...
      do{
         ...
         //rxHit1 = helios.GetRecoilXPos(231.5);
         //ryHit1 = helios.GetRecoilYPos(231.5);
