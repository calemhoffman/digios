...
class Monitors2 : public TSelector {
public :
   ...
   Monitors2(TTree * /*tree*/ =0) : fChain(0) { }
   virtual ~Monitors2() { }
   ...
   ClassDef(Monitors2,0);
};

#endif

#ifdef Monitors2_cxx
void Monitors2::Init(TTree *tree)
{
