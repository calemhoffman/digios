...
void ChainMonitors(int RUNNUM = -1, int RUNNUM2 = -1, bool saveCanvas = false, bool isTraceON = false) {
  ...
  if( RUNNUM == -1){
    ...
    //chain->Add("../root_data/gen_run02[1-9].root"); // 137 ug CD2. 20Ne(d,p) //run 20 has incorrect branches
    //chain->Add("../root_data/gen_run03[0-6].root"); // 15N(d,p)    
  
    chain->Add("../root_data/gen_run03[7-9].root"); // 10Be(d,p)
    chain->Add("../root_data/gen_run04[0-2].root"); // 10Be(d,p)
    
    //chain->Add("../root_data/gen_run043.root"); // ryan testing ;
    ...
    //chain->Add("../root_data/gen_run10[1-2].root"); // 10Be(t,p) good beam
    //chain->Add("../root_data/gen_run10[4-9].root"); // 10Be(t,p) good beam
    ...
    //chain->Add("../root_data/gen_run52[0-8].root"); // 10Be(t,p) good beam super high purity, adjusted target position
    ...
    //chain->Add("../root_data/trace_run528.root"); 
